...
public class shopServiceImpl implements shopService{
	...
	public List<Snackinfo> getHotSnack() {
		Map<String,String> map=new HashMap<String,String>();
		 ...
		 Date firstDayOfMonth = DateUtil.getFirstDayOfMonth(cal.get(Calendar.YEAR),cal.get(Calendar.MONTH)+1);
		 Date lastDayOfMonth = DateUtil.getLastDayOfMonth(cal.get(Calendar.YEAR),cal.get(Calendar.MONTH)+1);
		/* 测试程序*/
