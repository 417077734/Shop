...
<div class="container header">
	<div class="span5">
		<div class="logo">
				<img id="logoPic" src="${pageContext.request.contextPath}/image/trimImg/snackBZ.jpg" style="display: block;" alt="酒品商城"/>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
	...
	<div class="span24">
		<ul class="mainNav">
			...
			<li>
				<a href="${pageContext.request.contextPath}/shop/puffingType?type=1">啤酒</a>
				|
			</li>
			<li>
				<a href="${pageContext.request.contextPath}/shop/puffingType?type=2">白酒</a>
				|
			</li>
			<li>
				<a href="${pageContext.request.contextPath}/shop/puffingType?type=3">葡萄酒</a>
				|
			</li>
			<li>
