...
<div class="span11">
		...
		<div class="weixin">
			    ...
			    <img id="ewm" style="display:none;" src="#" alt="微信图标" class="weixin-ewm"/>
		</div>
</div>
...
<div class="headerad">
	...
	<div class="span24">
		<ul class="mainNav">
			...
			<li>
				<a href="${pageContext.request.contextPath}/shop/puffingType?type=1">啤酒类</a>
				|
			</li>
			<li>
				<a href="${pageContext.request.contextPath}/shop/puffingType?type=2">白酒类</a>
				|
			</li>
			<li>
				<a href="${pageContext.request.contextPath}/shop/puffingType?type=3">葡萄酒类</a>
				|
			</li>
			<li>
						 ...
						 <td valign="top" align="middle">
							 <table cellSpacing=0 cellPadding=0 width=150 border=0>
							  ...
							  <table id=child1 style="DISPLaY: block;" cellSpacing=0 cellPadding=0 width=150 border=0>
								 <tr height=20>
									  <td>
									  	<a style="cursor: pointer;font-size: 15px;color: red;margin-top: 60px;margin-left: 35px;" href="${pageContext.request.contextPath}/user/userInfo" target="right">个人中心</a>
									  </td>
								  </tr>
								  <tr height=20>
									  <td>
									 	 <a style="cursor: pointer;font-size: 15px;color: red;margin-top: 60px;margin-left: 35px" class="menuChild" href="${pageContext.request.contextPath}/user/userGoOrder" target="right">我的订单</a>
									  </td>
								  </tr>
								  <tr height=20>
									  <td>
									  	<a style="cursor: pointer;font-size: 15px;color: red;margin-top: 60px;margin-left: 35px" class="menuChild" href="${pageContext.request.contextPath}/user/userGoSuccessOrder" target="right">历史订单</a>
									  </td>
								  </tr>
							  </table>
							 <%-- <table cellSpacing=0 cellPadding=0 width=150 border=0>
...
<div class="container footer">
	<div class="span24">
		<div class="copyright">沈阳理工大学</div>
	</div>
</div>
